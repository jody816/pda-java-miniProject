...
@Getter
public enum RestaurantDummyData {
    BapPlus("밥플러스", Restaurant.builder()
            .id(1)
            .name("밥플러스")
            .categoryId(1)
    ...
    DaMion("담미온", Restaurant.builder()
            ...
            .build()),
    JejuNoodle("제주국수", Restaurant.builder()
            .id(3)
            .name("제주국수")
            .categoryId(1)
            ...
            .build()),
    kindZZaZang("착한짜장", Restaurant.builder()
            .id(1)
            .name("착한짜장")
            .categoryId(2)
            ...
            .build()),
    eGaNe("이가네 양꼬치", Restaurant.builder()
            .id(2)
            .name("이가네 양꼬치")
            .categoryId(2)
            ...
            .build()),
    goToWork("고투웤", Restaurant.builder()
            .id(3)
            .name("고투웤")
            .categoryId(2)
            ...
            .build()),
    HoRang("호랭이 초밥", Restaurant.builder()
            .id(1)
            .name("호랭이 초밥")
            .categoryId(3)
    ...
    Dojo("도죠", Restaurant.builder()
            ...
            .build()),
    GyoJo("교대 일층집", Restaurant.builder()
            .id(3)
            .name("교대 일층집")
            .categoryId(3)
            .address("교대 이층집 아래")
            ...
            .build()),
    MeDoIn("미도인 성수", Restaurant.builder()
            .id(1)
            .name("미도인 성수")
            .categoryId(4)
            ...
            .build()),
    Kangaroo("캥거루고깃집", Restaurant.builder()
            .id(2)
            .name("캥거루고깃집")
            .categoryId(4)
            ...
            .build()),
    Java("자바와 신희을", Restaurant.builder()
            .id(3)
            .name("자바와 신희을")
            .categoryId(4)
    ...
    RestaurantDummyData(String id, Restaurant restaurant) {
        this.id = id;
